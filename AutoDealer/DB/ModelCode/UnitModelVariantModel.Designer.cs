...
namespace AutoDealer.DB.DMS
{
    ...
    [Persistent(@"unit_model_variant")]
    public partial class UnitModelVariantModel : XPLiteObject
    {
        long fid_variant;
        [Key(true)]
        ...
        [Size(255)]
        public string nama_variant
        {
            get { return fnama_variant; }
            set { SetPropertyValue<string>("nama_variant", ref fnama_variant, value); }
        }
        string fcreated_by;
        [Size(255)]
