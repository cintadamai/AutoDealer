...
namespace AutoDealer.DB.its_honda
{
    ...
    [Persistent(@"jabatans")]
    public partial class JabatansModel : XPLiteObject
    {
        long fid;
        [Key(true)]
        public long id
        ...
        string fnama_jabatan;
        [Size(255)]
        public string nama_jabatan
        {
            get { return fnama_jabatan; }
            set { SetPropertyValue<string>("nama_jabatan", ref fnama_jabatan, value); }
        }
        DateTime fcreatedAt;
